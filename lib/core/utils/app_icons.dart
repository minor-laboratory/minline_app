...
/// 앱 전체에서 사용되는 아이콘 매핑
/// flutter_lucide 패키지 사용
///
/// 사용법:
/// AppIcons.home - 기본 아이콘
class AppIcons {
  // Navigation Icons
  static const IconData timeline = LucideIcons.sparkles;
  ...
  static const IconData error = LucideIcons.circle_x;
  ...
  static const IconData notificationOff = LucideIcons.bell_off;
  ...
  // Cloud and sync icons
  static const IconData sync = LucideIcons.refresh_cw;
